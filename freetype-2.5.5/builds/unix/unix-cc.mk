...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -DDARWIN_NO_CARBON  -DFT_CONFIG_OPTION_SYSTEM_ZLIB  -DFT_CONFIG_OPTION_USE_BZIP2 -I/usr/local/Cellar/libpng/1.6.16/include/libpng16 -DFT_CONFIG_OPTION_USE_PNG -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS :=  -lz -lbz2 -L/usr/local/Cellar/libpng/1.6.16/lib -lpng16
