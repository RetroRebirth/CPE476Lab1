...
SOURCES= main.o GLSL.o tiny_obj_loader.cc Camera.o Object.o Window.o World.o MatrixStack.o Booth.o SkyBox.o Session.o Texture.o Clicks.o ShootingGallery.o Sound.o WatermelonSmash.o Minigame.o Particle.o ParticleTexture.o Program.o FontEngine.o FontAtlas.o Karaoke.o Shop.o
