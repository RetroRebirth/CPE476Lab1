...
void World::setupOverWorld() {
   ...
   booth1_1->load(WALL_FILE_NAME);
   booth1_1->translate(glm::vec3(10.0f, 1.0f, -15.0f));
   booth1_1->scale(glm::vec3(10.0f, 5.0f, 5.0f));
   ...
   booth1_2->load(WALL_FILE_NAME);
   booth1_2->translate(glm::vec3(-10.0f, 1.0f, -15.0f));
   booth1_2->scale(glm::vec3(10.0f, 5.0f, 5.0f));
   //booth1->scale(glm::vec3(5.0f, 5.0f, 5.0f));
   ...
   booth2->translate(glm::vec3(15.0f, 1.0f, 0.0f));
   ...
   booth3->translate(glm::vec3(-15.0f, 1.0f, 0.0f));
   ...
   booth4_1->load(WALL_FILE_NAME);
   booth4_1->translate(glm::vec3(10.0f, 1.0f, 17.0f));
   booth4_1->scale(glm::vec3(5.0f, 6.0f, 2.5f));
   //booth1->scale(glm::vec3(5.0f, 5.0f, 5.0f));
   ...
   booth4_2->load(WALL_FILE_NAME);
   booth4_2->translate(glm::vec3(-10.0f, 1.0f, 17.0f));
   booth4_2->scale(glm::vec3(5.0f, 6.0f, 2.5f));
   //booth1->scale(glm::vec3(5.0f, 5.0f, 5.0f));
   ...
   booth4_3->load(WALL_FILE_NAME);
   booth4_3->translate(glm::vec3(0.0f, 1.0f, 17.0f));
   booth4_3->scale(glm::vec3(5.0f, 6.0f, 2.5f));
   //booth1->scale(glm::vec3(5.0f, 5.0f, 5.0f));
